...
`,// (ends: /components/examplelib.html) 
  ...
  "/components/modulowebsite/demo.html": // (54 lines)
`<div class="demo-wrapper
    ...
    <div class="editor-toolbar">
        ...
        {% if state.showpreview %}
            ...
            <button class="m-Btn"
                    title="Switch to full screen view of code" @click:=script.doFullscreen>
                <span alt="Full Screen"><span>&#x26F6;</span>
            </button>
        {% endif %}
    </div>
...
`,// (ends: /components/modulowebsite/demo.html) 
  ...
  "/components/modulowebsite/demo.css": // (66 lines)
`.demo-wrapper {
    position: relative;
    display: block;
    width: 100%;
...
`,// (ends: /components/modulowebsite/demo.css) 
  ...
  "/components/modulowebsite/demo.js": // (203 lines)
