    ...
    <main class="Main Main--fluid Main--withSidebar">
        <aside class="TitleAside TitleAside--navBar">
            ...
            <nav class="TitleAside-navigation">
                <h3>Documentation</h3>
                <tutorial-DocSidebar></tutorial-DocSidebar>
            </nav>
        </aside>
...
`,// (ends: /components/layouts/base.html) 
  ...
  "/components/modulowebsite.html": // (510 lines)
    ...
    <script>
        ...
        function codemirrorMount({el}) {
            ...
            const mountCM = () => {
                ...
                const cm = Modulo.globals.CodeMirror(el, {
                    //lineNumbers: true,
                    value: text,
                    mode: 'django',
                    theme: 'eclipse',
...
`,// (ends: /components/modulowebsite.html) 
  ...
  "/components/examplelib.html": // (559 lines)
`<module>
    <script>
