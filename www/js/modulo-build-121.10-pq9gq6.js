    ...
    updatedCallback(renderObj) {
        if (!this.element.isMounted) { // First time initialized
            ...
            if (mode === 'vanish' || mode === 'vanish-allow-script') {
                ...
                // ordering
                // for (const elem in this.element.querySelector('*')) {
                //     if (elem.hasAttribute('[component.children]')) { ..
                //     }
                // }
...
`,// (ends: /components/layouts/base.html) 
  ...
  "/components/modulowebsite.html": // (533 lines)
        ...
        function codemirrorMount({el}) {
            ...
            if (props.fromlibrary) {
                ...
                if (props.fromlibrary in componentTexts) {
                    text = componentTexts[props.fromlibrary].trim();
                } else {
