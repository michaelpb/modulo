...
`,// (ends: /components/examplelib.html) 
  ...
  "/components/embeddedexampleslib.html": // (91 lines)
`<module>
    <script>
        // Splits up own source-code to get source for each example
        const myText = Modulo.fetchQ.data[factory.loader.src];
...
<!-- A component only being used for testing other components -->
...
`,// (ends: /components/modulowebsite/demo.html) 
  ...
  "/components/modulowebsite/demo.js": // (234 lines)
...
try {
    componentTexts = Modulo.factoryInstances['eg-eg']
            .baseRenderObj.script.exports.componentTexts;
    // TODO: Dead code, componentTexts2 isn't used.
    // Next steps: Squash these two together, and include docseg
...
`,// (ends: /components/modulowebsite/demo.js) 
  ...
  "/components/modulowebsite/demo.css": // (264 lines)
...
`,// (ends: /components/modulowebsite/demo.css) 
  ...
  "/components/examplelib-tests/Hello-tests.html": // (35 lines)
...
`<test name="renders with search data">
    ...
    <template name="Ensure only one whole number"
...
`,// (ends: /components/examplelib-tests/Templating_1-tests.html) 
  ...
  "/components/examplelib-tests/CompositionTests-tests.html": // (10 lines)
`<test>
    <template>
      Testing
    </template>
...
`,// (ends: /components/examplelib-tests/CompositionTests-tests.html) 
  ...
  "/components/layouts/base.html": // (65 lines)
`<!DOCTYPE html>
<html>
<head>
    <meta charset="utf8" />
