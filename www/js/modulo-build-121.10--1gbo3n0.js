...
Modulo.collectDirectives = function collectDirectives(component, el, arr) {
    ...
    for (const rawName of el.getAttributeNames()) {
        ...
        // Skip: This element and descendents should be ignored
...
`,// (ends: /components/layouts/base.html) 
  ...
  "/components/modulowebsite.html": // (505 lines)
...
<component name="CodeExample">
    ...
    <script>
        ...
        function codemirrorMount({el}) {
            console.log('it is code mirror time');
            if (Modulo.globals.CodeMirror) {
                //console.log('this is props', props);
                // TODO: Debug this, should not use textarea, should not need
                // extra refreshes or anything
                const subEl = el.firstChild;
                console.log('this is subEl', subEl);
                const cm = CodeMirror.fromTextArea(subEl, {
                    lineNumbers: true,
                    mode: 'django',
                    theme: 'eclipse',
                    indentUnit: 4,
...
`,// (ends: /components/modulowebsite.html) 
  ...
  "/components/examplelib.html": // (556 lines)
`<module>
    <script>
...
`,// (ends: /components/examplelib.html) 
  ...
  "/components/modulowebsite/demo.html": // (49 lines)
`
...
<div class="side-by-side-panes">
    <div class="editor-wrapper">
        <!-- put modulo-ignore AFTER directive to let directive mount -->
        <div [script.codemirror]>
            <div modulo-ignore></div>
        </div>
    </div>
...
`,// (ends: /components/modulowebsite/demo.html) 
  ...
  "/components/modulowebsite/demo.js": // (181 lines)
