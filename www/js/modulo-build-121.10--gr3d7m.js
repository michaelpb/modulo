...
<!-- Demos mouseover, template filters and control flow
...
`,// (ends: /components/examplelib.html) 
  ...
  "/components/modulowebsite/demo.html": // (65 lines)
`<div class="demo-wrapper
    ...
    <div class="editor-toolbar">
        <p style="font-size: 11px; width: 120px; margin-right: 10px; text-align:right;
            ...
            <em>Note: This is just for exploring features. Your work will not be saved.</em>
        </p>
...
`,// (ends: /components/modulowebsite/demo.html) 
  ...
  "/components/modulowebsite/demo.js": // (219 lines)
...
`,// (ends: /components/modulowebsite/demo.js) 
  ...
  "/components/modulowebsite/demo.css": // (224 lines)
