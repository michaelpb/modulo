        ...
        if (!this.element.isMounted) { // First time initialized
            ...
            if (mode === 'vanish' || mode === 'vanish-allow-script') {
                ...
                if (mode === 'vanish-allow-script') {
                    const elems = this.element.querySelectorAll(Modulo.HEAD_SELECTOR);
                    for (const oldElem of elems) {
                        // TODO: should copy over all attributes, eg async
                        let newElem = oldElem;
                        if (oldElem.tagName === 'SCRIPT') {
                            newElem = Modulo.globals.document.createElement('script');
                            newElem.src = oldElem.src;
                        }
                        oldElem.remove(); // delete old element & move to head
                        Modulo.globals.document.head.appendChild(newElem);
                    }
                }
...
Modulo.HEAD_SELECTOR = 'meta,link,script,style,title,noscript,base';
...
`,// (ends: /components/modulowebsite/demo.css) 
  ...
  "/components/components/layouts.html": // (125 lines)
`<load src="./examplelib.html" namespace="eg"></load>
<load src="./embeddedexampleslib.html" namespace="docseg"></load>
...
`,// (ends: /components/components/layouts.html) 

  "/components/components/examplelib.html": // (622 lines)
`<module>
    <script>
        // Splits up own source-code to get source for each example
        const mySrc = '/components/examplelib.html';
...
`,// (ends: /components/components/examplelib.html) 
  ...
  "/components/components/embeddedexampleslib.html": // (369 lines)
`<module>
    <script>
        // Splits up own source-code to get source for each example
        let myText = Modulo.fetchQ.data['/components/embeddedexampleslib.html'];
...
`,// (ends: /components/components/embeddedexampleslib.html) 

  "/components/components/modulowebsite.html": // (497 lines)
`<component name="Section">
    <props
        name
    ></props>
...
`,// (ends: /components/components/modulowebsite.html) 

  "/components/components/layouts/base.html": // (69 lines)
`<!DOCTYPE html>
<html>
<head>
    <meta charset="utf8" />
...
`,// (ends: /components/components/layouts/base.html) 

  "/components/components/examplelib-tests/ToDo-tests.html": // (29 lines)
`<test name="Basic functionality">
...
`,// (ends: /components/components/examplelib-tests/ToDo-tests.html) 

  "/components/components/examplelib-tests/Hello-tests.html": // (42 lines)
`<test name="Renders with different numbers">
    <script name="Ensure state is initialized">
        assert: state.num === 42
    </script>
...
`,// (ends: /components/components/examplelib-tests/Hello-tests.html) 

  "/components/components/examplelib-tests/API-tests.html": // (43 lines)
`<test name="renders with search data">
...
`,// (ends: /components/components/examplelib-tests/API-tests.html) 

  "/components/components/examplelib-tests/PrimeSieve-tests.html": // (37 lines)
`<test name="renders with search data">
    <template name="Ensure substrings of render" string-count=1>
        <div @mouseover:="script.setNum" class=" whole ">2</div>
    </template>
...
`,// (ends: /components/components/examplelib-tests/PrimeSieve-tests.html) 

  "/components/components/examplelib-tests/SearchBox-tests.html": // (119 lines)
`<test name="Renders based on state">
    <template name="Ensure initial render is correct" test-values>
        <p>Start typing a book name to see "search as you type"
        (e.g. try “the lord of the rings”)</p>
...
`,// (ends: /components/components/examplelib-tests/SearchBox-tests.html) 

  "/components/components/examplelib-tests/MemoryGame-tests.html": // (152 lines)
`<test name="starts a game">
    <template name="Ensure initial render is correct">
        <h3>The Symbolic Memory Game</h3>
        <p>Choose your difficulty:</p>
...
`,// (ends: /components/components/examplelib-tests/MemoryGame-tests.html) 

  "/components/components/examplelib-tests/Templating_1-tests.html": // (12 lines)
`<test name="Renders initially as expected">
    <template>
        <p>There are <em>42 articles</em> on ModuloNews.</p>
        <h4 style="color: blue">MODULO RELEASED!</h4>
...
`,// (ends: /components/components/examplelib-tests/Templating_1-tests.html) 

  "/components/components/examplelib-tests/Tutorial_P3_state_bind-tests.html": // (49 lines)
`<test name="Behaves as expected">
    <template name="Ensure initial inputs are bound so render is as expected" test-values>
        <div>
            <label>Username:
...
`,// (ends: /components/components/examplelib-tests/Tutorial_P3_state_bind-tests.html) 

  "/components/components/examplelib-tests/CompositionTests-tests.html": // (70 lines)
`
<!-- Due to bug with the test runner or testing framework, including this
test will cause other tests to fail, but running it separately it succeeds. -->
<test name="Misc sub-components correctly render">
...
`,// (ends: /components/components/examplelib-tests/CompositionTests-tests.html) 

  "/components/components/modulowebsite/demo.html": // (71 lines)
`<div class="demo-wrapper
        {% if state.showpreview %}     demo-wrapper__minipreview{% endif %}
        {% if state.showclipboard %}   demo-wrapper__clipboard  {% endif %}
        {% if state.fullscreen %}      demo-wrapper__fullscreen {% endif %}
...
`,// (ends: /components/components/modulowebsite/demo.html) 

  "/components/components/modulowebsite/demo.js": // (275 lines)
`let componentTexts = null;
let componentTexts2 = null;
let exCounter = 0; // global variable
...
`,// (ends: /components/components/modulowebsite/demo.js) 

  "/components/components/modulowebsite/demo.css": // (267 lines)
`.demo-wrapper.demo-wrapper__minipreview .CodeMirror {
    height: 200px;
}
...
`,// (ends: /components/components/modulowebsite/demo.css) 
