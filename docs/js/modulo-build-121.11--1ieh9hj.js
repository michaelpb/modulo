...
Modulo.cparts.component = class Component extends Modulo.FactoryCPart {
    ...
    updatedCallback(renderObj) {
        ...
        if (!this.element.isMounted) { // First time initialized
            ...
            if (mode === 'vanish' || mode === 'vanish-into-document') {
                ...
                const _childrenOf = tag => {
                    const elem = this.element.querySelector(tag);
                    return elem ? elem.childNodes : [];
                }
...
`,// (ends: /components/modulowebsite.html) 
  ...
  "/components/layouts/base.html": // (62 lines)
`<!DOCTYPE html>
<html>
<head>
    <meta charset="utf8" />
...
`,// (ends: /components/components/modulowebsite.html) 
  ...
  "/components/components/layouts/base.html": // (62 lines)
`<!DOCTYPE html>
<html>
<head>
    <meta charset="utf8" />
