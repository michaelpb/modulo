...
return OUT.join("");
                ...
                "use strict";Modulo.assets.functions["78vnsm"]= function (CTX, G){
var OUT=[];
OUT.push("\n    API data: <pre>"); // "API data: <pre>"
OUT.push(G.escapeHTML(G.filters["truncate"](G.filters["json"](CTX.state.data),80))); // "state.data|json|truncate:80"
OUT.push("</pre>\n    <button @click:=script.fetchMe>Get API data</button>\n"); // "</pre>\n    <button @click:=script.fetchMe>Get API data</button>"

return OUT.join("");
};
            
                "use strict";Modulo.assets.functions["xn064s4"]= function (CTX, G){
var OUT=[];
OUT.push("\n    <p>"); // "<p>"
