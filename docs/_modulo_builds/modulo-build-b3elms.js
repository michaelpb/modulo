...
return OUT.join("");
                ...
                "use strict";Modulo.assets.functions["x7opur5"]= function (Modulo, factory, module, component, template, element, cparts){var script = { exports: {} };  function __set(name, value) { if (name === 'Modulo') Modulo = value; if (name === 'factory') factory = value; if (name === 'module') module = value; if (name === 'component') component = value; if (name === 'template') template = value; if (name === 'element') element = value; if (name === 'cparts') cparts = value; }
...
"reconcileCallback": typeof reconcileCallback !== "undefined" ? reconcileCallback : undefined,
"updateCallback": typeof updateCallback !== "undefined" ? updateCallback : undefined,
"eventCallback": typeof eventCallback !== "undefined" ? eventCallback : undefined,
"eventCleanupCallback": typeof eventCleanupCallback !== "undefined" ? eventCleanupCallback : undefined,
"gotClicked": typeof gotClicked !== "undefined" ? gotClicked : undefined,
 setLocalVariable: __set, exports: script.exports}
};
...
return OUT.join("");
                ...
                "use strict";Modulo.assets.functions["x1oailk0"]= function (Modulo, factory, module, component, template, state, element, cparts){var script = { exports: {} };  function __set(name, value) { if (name === 'Modulo') Modulo = value; if (name === 'factory') factory = value; if (name === 'module') module = value; if (name === 'component') component = value; if (name === 'template') template = value; if (name === 'state') state = value; if (name === 'element') element = value; if (name === 'cparts') cparts = value; }
...
return { "_logInfo": typeof _logInfo !== "undefined" ? _logInfo : undefined,
"to": typeof to !== "undefined" ? to : undefined,
"prepareCallback": typeof prepareCallback !== "undefined" ? prepareCallback : undefined,
"renderCallback": typeof renderCallback !== "undefined" ? renderCallback : undefined,
"reconcileCallback": typeof reconcileCallback !== "undefined" ? reconcileCallback : undefined,
"updateCallback": typeof updateCallback !== "undefined" ? updateCallback : undefined,
...
return OUT.join("");
                ...
                "use strict";Modulo.assets.functions["bsllcl"]= function (CTX, G){
var OUT=[];
...
return OUT.join("");
                ...
                "use strict";Modulo.assets.functions["x97n9if"]= function (CTX, G){
var OUT=[];
