...
"run": typeof run !== "undefined" ? run : undefined,
 setLocalVariable: __set, exports: script.exports}
                ...
                "use strict";Modulo.assets.functions["xnjq9ng"]= function (CTX, G){
var OUT=[];
...
return OUT.join("");
                ...
                "use strict";Modulo.assets.functions["pqput6"]= function (CTX, G){
var OUT=[];
...
return OUT.join("");
                ...
                "use strict";Modulo.assets.functions["xvdjht9"]= function (CTX, G){
var OUT=[];
...
return OUT.join("");
                ...
                "use strict";Modulo.assets.functions["x1ttadi3"]= function (CTX, G){
var OUT=[];
OUT.push("\n<ul>\n    "); // "<ul>"
...
return OUT.join("");
                ...
                "use strict";Modulo.assets.functions["d2qplu"]= function (CTX, G){
var OUT=[];
OUT.push("\n    <p>Before comment</p>\n    "); // "<p>Before comment</p>"
/* // "comment \"Optional note\""
OUT.push("\n        <p>Commented out text that will be ignored\n          "); // "<p>Commented out text that will be ignored"
OUT.push(G.escapeHTML(G.filters["brokenFilter"](CTX.nonExistingVar,"abc"))); // "nonExistingVar|brokenFilter:\"abc\""
OUT.push("</p>\n    "); // "</p>"
*/ // "endcomment"
OUT.push("\n    <p>After comment</p>\n"); // "<p>After comment</p>"
...
return OUT.join("");
                ...
                "use strict";Modulo.assets.functions["xdfd8k"]= function (CTX, G){
var OUT=[];
OUT.push("\n    <ul>\n        "); // "<ul>"
var ARR0=CTX.state.athletes;for (var KEY in ARR0) {CTX. athlete=ARR0[KEY]; // "for athlete in state.athletes"
OUT.push("\n            <li>"); // "<li>"
OUT.push(G.escapeHTML(CTX.athlete.name)); // "athlete.name"
OUT.push("</li>\n        "); // "</li>"
} // "endfor"
OUT.push("\n    </ul>\n"); // "</ul>"
...
return OUT.join("");
                ...
                "use strict";Modulo.assets.functions["1fbl7a3"]= function (CTX, G){
var OUT=[];
OUT.push("\n    <ul>\n        "); // "<ul>"
var ARR0=CTX.state.fave_colors;for (var KEY in ARR0) {CTX.name=KEY;CTX.color=ARR0[KEY]; // "for name, color in state.fave_colors"
OUT.push("\n            <li><strong>"); // "<li><strong>"
...
return OUT.join("");
                ...
                "use strict";Modulo.assets.functions["1jm0utj"]= function (CTX, G){
var OUT=[];
OUT.push("\n    "); // ""
...
return OUT.join("");
                ...
                "use strict";Modulo.assets.functions["nmapbj"]= function (CTX, G){
var OUT=[];
OUT.push("\n    "); // ""
if (CTX.state.athletes) { // "if state.athletes"
OUT.push("\n        Athletes exists. Total athletes: "); // "Athletes exists. Total athletes:"
OUT.push(G.escapeHTML(G.filters["length"](CTX.state.athletes))); // "state.athletes|length"
OUT.push("\n    "); // ""
} else if (CTX.state.benched) { // "elif state.benched"
OUT.push("\n        Benched exists. Total benched: "); // "Benched exists. Total benched:"
OUT.push(G.escapeHTML(G.filters["length"](CTX.state.benched))); // "state.benched|length"
OUT.push("\n    "); // ""
} else { // "else"
OUT.push("\n        No athletes.\n    "); // "No athletes."
} // "endif"
...
return OUT.join("");
                ...
                "use strict";Modulo.assets.functions["pdhckq"]= function (CTX, G){
var OUT=[];
OUT.push("\n    "); // ""
...
return OUT.join("");
                ...
                "use strict";Modulo.assets.functions["369a6v"]= function (CTX, G){
var OUT=[];
OUT.push("\n    "); // ""
if (CTX.state.somevar != "x") { // "if state.somevar != \"x\""
...
return OUT.join("");
                ...
                "use strict";Modulo.assets.functions["x13dcch2"]= function (CTX, G){
var OUT=[];
OUT.push("\n    "); // ""
...
return OUT.join("");
                ...
                "use strict";Modulo.assets.functions["x1r5jvp5"]= function (CTX, G){
var OUT=[];
OUT.push("\n    "); // ""
...
return OUT.join("");
                ...
                "use strict";Modulo.assets.functions["xe1v6pk"]= function (CTX, G){
var OUT=[];
OUT.push("\n    "); // ""
...
return OUT.join("");
                ...
                "use strict";Modulo.assets.functions["x1g0dl1p"]= function (CTX, G){
var OUT=[];
OUT.push("\n    "); // ""
...
OUT.push(G.escapeHTML(CTX.state.era)); // "state.era"
OUT.push("\"\n    "); // "\""
} // "endif"
OUT.push("\n"); // ""
...
return OUT.join("");
                ...
                "use strict";Modulo.assets.functions["1hh0pof"]= function (CTX, G){
var OUT=[];
OUT.push("\n    "); // ""
...
return OUT.join("");
                ...
                "use strict";Modulo.assets.functions["1g5u6ig"]= function (CTX, G){
var OUT=[];
OUT.push("\n    "); // ""
OUT.push(G.escapeHTML(G.filters["add"](CTX.state.value,7))); // "state.value|add:7"
OUT.push(" hacks <br />\n    "); // "hacks <br />"
OUT.push(G.escapeHTML(G.filters["add"](CTX.state.value,CTX.state.another))); // "state.value|add:state.another"
OUT.push(" hz\n"); // "hz"

return OUT.join("");
};
            
                "use strict";Modulo.assets.functions["2mm5s4"]= function (CTX, G){
var OUT=[];
OUT.push("\n    Valid: "); // "Valid:"
OUT.push(G.escapeHTML(G.filters["allow"](CTX.state.value,"orange,apple,pear"))); // "state.value|allow:\"orange,apple,pear\""
OUT.push(" <br />\n    Invalid: "); // "<br />\n    Invalid:"
OUT.push(G.escapeHTML(G.filters["allow"](CTX.state.value,"a,b,c"))); // "state.value|allow:\"a,b,c\""
OUT.push(" <br />\n    Invalid + default: "); // "<br />\n    Invalid + default:"
OUT.push(G.escapeHTML(G.filters["default"](G.filters["allow"](CTX.state.value,"a,b,c"),"Oops!"))); // "state.value|allow:\"a,b,c\"|default:\"Oops!\""
OUT.push("\n"); // ""

return OUT.join("");
};
            
                "use strict";Modulo.assets.functions["lm5ctd"]= function (CTX, G){
var OUT=[];
OUT.push("\n    The "); // "The"
OUT.push(G.escapeHTML(G.filters["capfirst"](CTX.state.value))); // "state.value|capfirst"
OUT.push(" framework is my favorite\n"); // "framework is my favorite"

return OUT.join("");
};
            
                "use strict";Modulo.assets.functions["b3eodp"]= function (CTX, G){
var OUT=[];
OUT.push("\n    Fave snack: "); // "Fave snack:"
OUT.push(G.escapeHTML(G.filters["default"](CTX.state.snack,"icecream"))); // "state.snack|default:\"icecream\""
OUT.push(" <br />\n    Snack count: "); // "<br />\n    Snack count:"
OUT.push(G.escapeHTML(G.filters["default"](CTX.state.count,"none"))); // "state.count|default:\"none\""
OUT.push(" <br />\n    Fave soda: "); // "<br />\n    Fave soda:"
OUT.push(G.escapeHTML(G.filters["default"](CTX.state.soda,"Cola"))); // "state.soda|default:\"Cola\""
OUT.push("\n"); // ""

return OUT.join("");
};
            
                "use strict";Modulo.assets.functions["3dart2"]= function (CTX, G){
var OUT=[];
OUT.push("\n    Can "); // "Can"
OUT.push(G.escapeHTML(CTX.state.value)); // "state.value"
OUT.push(" divide by 3? <br />\n    "); // "divide by 3? <br />"
OUT.push(G.escapeHTML(G.filters["divisibleby"](CTX.state.value,3))); // "state.value|divisibleby:3"
OUT.push(" <br />\n    "); // "<br />"
...
return OUT.join("");
                ...
                "use strict";Modulo.assets.functions["xqp4i89"]= function (CTX, G){
var OUT=[];
OUT.push("\n    Result: "); // "Result:"
OUT.push(G.escapeHTML(G.filters["escapejs"](CTX.state.value))); // "state.value|escapejs"
OUT.push(" <br />\n"); // "<br />"

return OUT.join("");
};
            
                "use strict";Modulo.assets.functions["1b3dtg5"]= function (CTX, G){
var OUT=[];
OUT.push("\n    <p>"); // "<p>"
OUT.push(G.escapeHTML(G.filters["first"](CTX.state.athletes))); // "state.athletes|first"
OUT.push("</p>\n"); // "</p>"

return OUT.join("");
};
            
                "use strict";Modulo.assets.functions["172bvr5"]= function (CTX, G){
var OUT=[];
OUT.push("\n    <p>"); // "<p>"
OUT.push(G.escapeHTML(G.filters["join"](CTX.state.athletes))); // "state.athletes|join"
OUT.push("</p>\n    <p>"); // "</p>\n    <p>"
OUT.push(G.escapeHTML(G.filters["join"](CTX.state.athletes," + "))); // "state.athletes|join:\" + \""
OUT.push("</p>\n"); // "</p>"
...
return OUT.join("");
                ...
                "use strict";Modulo.assets.functions["1ucsrdb"]= function (CTX, G){
var OUT=[];
OUT.push("\n    <pre>"); // "<pre>"
OUT.push(G.escapeHTML(G.filters["json"](CTX.state.athletes))); // "state.athletes|json"
OUT.push("</pre>\n    <pre>"); // "</pre>\n    <pre>"
OUT.push(G.escapeHTML(G.filters["json"](CTX.state.athletes,2))); // "state.athletes|json:2"
OUT.push("</pre>\n"); // "</pre>"

return OUT.join("");
};
            
                "use strict";Modulo.assets.functions["136duj5"]= function (CTX, G){
var OUT=[];
OUT.push("\n    <p>"); // "<p>"
OUT.push(G.escapeHTML(G.filters["last"](CTX.state.athletes))); // "state.athletes|last"
OUT.push("</p>\n"); // "</p>"

return OUT.join("");
};
            
                "use strict";Modulo.assets.functions["1v1b63b"]= function (CTX, G){
var OUT=[];
OUT.push("\n    <p>Sentence length: "); // "<p>Sentence length:"
OUT.push(G.escapeHTML(G.filters["length"](CTX.state.sentence))); // "state.sentence|length"
OUT.push("</p>\n    <p>Flowers length: "); // "</p>\n    <p>Flowers length:"
OUT.push(G.escapeHTML(G.filters["length"](CTX.state.flowers))); // "state.flowers|length"
OUT.push("</p>\n    <p>Flights length: "); // "</p>\n    <p>Flights length:"
OUT.push(G.escapeHTML(G.filters["length"](CTX.state.flights))); // "state.flights|length"
OUT.push("</p>\n"); // "</p>"

return OUT.join("");
};
            
                "use strict";Modulo.assets.functions["8mvf6k"]= function (CTX, G){
var OUT=[];
OUT.push("\n    <p>Without: "); // "<p>Without:"
OUT.push(G.escapeHTML(CTX.state.word)); // "state.word"
OUT.push("</p>\n    <p>Lower: "); // "</p>\n    <p>Lower:"
OUT.push(G.escapeHTML(G.filters["lower"](CTX.state.word))); // "state.word|lower"
OUT.push("</p>\n"); // "</p>"

return OUT.join("");
};
            
                "use strict";Modulo.assets.functions["x10k5tl3"]= function (CTX, G){
var OUT=[];
OUT.push("\n    We visited "); // "We visited"
OUT.push(G.escapeHTML(G.filters["length"](CTX.state.citynames))); // "state.citynames|length"
OUT.push(" \n    "); // ""
OUT.push(G.escapeHTML(G.filters["pluralize"](G.filters["length"](CTX.state.citynames),"cities,city"))); // "state.citynames|length|pluralize:\"cities,city\""
OUT.push("\n\n    and picked "); // "and picked"
OUT.push(G.escapeHTML(G.filters["length"](CTX.state.flowers))); // "state.flowers|length"
OUT.push(" \n    flower"); // "flower"
OUT.push(G.escapeHTML(G.filters["pluralize"](G.filters["length"](CTX.state.flowers),"s"))); // "state.flowers|length|pluralize:\"s\""
OUT.push("\n"); // ""

return OUT.join("");
};
            
                "use strict";Modulo.assets.functions["xbd231s"]= function (CTX, G){
var OUT=[];
OUT.push("\n    "); // ""
OUT.push(G.escapeHTML(G.filters["subtract"](CTX.state.value,3))); // "state.value|subtract:3"
OUT.push(" hacks <br />\n    "); // "hacks <br />"
OUT.push(G.escapeHTML(G.filters["subtract"](CTX.state.value,CTX.state.another))); // "state.value|subtract:state.another"
OUT.push(" is the answer\n"); // "is the answer"

return OUT.join("");
};
            
                "use strict";Modulo.assets.functions["x1ujhqe9"]= function (CTX, G){
var OUT=[];
OUT.push("\n    <p>Long sentence: "); // "<p>Long sentence:"
OUT.push(G.escapeHTML(G.filters["truncate"](CTX.state.sentence,20))); // "state.sentence|truncate:20"
OUT.push("</p>\n    <p>Short word: "); // "</p>\n    <p>Short word:"
OUT.push(G.escapeHTML(G.filters["truncate"](CTX.state.word,20))); // "state.word|truncate:20"
OUT.push("</p>\n"); // "</p>"

return OUT.join("");
};
            
                "use strict";Modulo.assets.functions["x11qvtla"]= function (CTX, G){
var OUT=[];
OUT.push("\n    <p>"); // "<p>"
OUT.push(G.escapeHTML(G.filters["join"](G.filters["reversed"](CTX.state.flowers)))); // "state.flowers|reversed|join"
OUT.push("</p>\n    "); // "</p>"
var ARR0=G.filters["reversed"](CTX.state.cities);for (var KEY in ARR0) {CTX. city=ARR0[KEY]; // "for city in state.cities|reversed"
OUT.push("\n        <p>"); // "<p>"
OUT.push(G.escapeHTML(CTX.city)); // "city"
OUT.push("</p>\n    "); // "</p>"
} // "endfor"
OUT.push("\n"); // ""
...
return OUT.join("");
                ...
                "use strict";Modulo.assets.functions["xphkehc"]= function (CTX, G){
var OUT=[];
OUT.push("\n    <p>Without: "); // "<p>Without:"
OUT.push(G.escapeHTML(CTX.state.word)); // "state.word"
OUT.push("</p>\n    <p>Upper: "); // "</p>\n    <p>Upper:"
OUT.push(G.escapeHTML(G.filters["upper"](CTX.state.word))); // "state.word|upper"
OUT.push("</p>\n"); // "</p>"
