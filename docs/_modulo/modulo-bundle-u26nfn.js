...
};Modulo.assets.functions["160dd20"]= function (CTX, G){
var OUT=[];
OUT.push("\n<p>Nonsense poem:</p> <pre>\nProfessor "); // "<p>Nonsense poem:</p> <pre>\nProfessor"
OUT.push(G.escapeHTML(G.filters["capfirst"](CTX.state.verb))); // "state.verb|capfirst"
OUT.push(" who\n"); // "who"
OUT.push(G.escapeHTML(CTX.state.verb)); // "state.verb"
OUT.push("ed a "); // "ed a"
OUT.push(G.escapeHTML(CTX.state.noun)); // "state.noun"
OUT.push(",\ntaught "); // ",\ntaught"
OUT.push(G.escapeHTML(CTX.state.verb)); // "state.verb"
OUT.push("ing in\nthe City of "); // "ing in\nthe City of"
OUT.push(G.escapeHTML(G.filters["capfirst"](CTX.state.noun))); // "state.noun|capfirst"
OUT.push(",\nto "); // ",\nto"
...
return OUT.join("");
};Modulo.assets.functions["1dm0d02"]= function (CTX, G){
var OUT=[];
OUT.push("\n    <input name=\"perc\" [state.bind] />% of\n    <input name=\"total\" [state.bind] />\n    is: "); // "<input name=\"perc\" [state.bind] />% of\n    <input name=\"total\" [state.bind] />\n    is:"
OUT.push(G.escapeHTML(CTX.script.calcResult)); // "script.calcResult"
OUT.push("\n"); // ""

return OUT.join("");
};Modulo.assets.functions["1f2r1p6"]= function (CTX, G){
var OUT=[];
...
OUT.push(G.escapeHTML(G.filters["get"](CTX.pair,0))); // "pair|get:0"
OUT.push(" ("); // "("
OUT.push(G.escapeHTML(G.filters["get"](CTX.pair,1))); // "pair|get:1"
OUT.push(")\n                    </span>\n                "); // ")\n                    </span>"
} else { // "else"
...
return { "countUp": typeof countUp !== "undefined" ? countUp : undefined,
 setLocalVariable: __set, exports: script.exports}
};Modulo.assets.functions["1shsut8"]= function (CTX, G){
var OUT=[];
OUT.push("\n<p>"); // "<p>"
OUT.push(G.escapeHTML(CTX.state.name)); // "state.name"
OUT.push(" | "); // "|"
OUT.push(G.escapeHTML(CTX.state.location)); // "state.location"
OUT.push("</p>\n<p>"); // "</p>\n<p>"
OUT.push(G.escapeHTML(CTX.state.bio)); // "state.bio"
OUT.push("</p>\n<a href=\"https://github.com/"); // "</p>\n<a href=\"https://github.com/"
OUT.push(G.escapeHTML(CTX.state.search)); // "state.search"
...
"githubCallback": typeof githubCallback !== "undefined" ? githubCallback : undefined,
 setLocalVariable: __set, exports: script.exports}
};Modulo.assets.functions["k5gv4e"]= function (CTX, G){
var OUT=[];
OUT.push("\n        <div class=\"split\">\n            <div style=\"height: "); // "<div class=\"split\">\n            <div style=\"height:"
OUT.push(G.escapeHTML(G.filters["add"](G.filters["default"](G.filters["number"](CTX.props.vsize),170),2))); // "props.vsize|number|default:170|add:2"
...
OUT.push(G.escapeHTML(CTX.props.preview)); // "props.preview"
OUT.push("</code>\n                        </div>\n                    "); // "</code>\n                        </div>"
} // "endif"
OUT.push("\n                "); // ""
} // "endif"
...
"dataBackCallback": typeof dataBackCallback !== "undefined" ? dataBackCallback : undefined,
 setLocalVariable: __set, exports: script.exports}
};Modulo.assets.functions["pqput6"]= function (CTX, G){
var OUT=[];
...
return OUT.join("");
};Modulo.assets.functions["q6b5d2"]= function (CTX, G){
var OUT=[];
OUT.push("\n    <button @click:=script.countUp>Hello "); // "<button @click:=script.countUp>Hello"
OUT.push(G.escapeHTML(CTX.state.num)); // "state.num"
OUT.push("</button>\n"); // "</button>"
...
return {  setLocalVariable: __set, exports: script.exports}
};Modulo.assets.functions["x1k5ujh9"]= function (CTX, G){
var OUT=[];
...
OUT.push(G.escapeHTML(CTX.state.opacity)); // "state.opacity"
OUT.push(";\n            color: "); // ";\n            color:"
OUT.push(G.escapeHTML(G.filters["default"](G.filters["allow"](CTX.state.color,"green,blue"),"red"))); // "state.color|allow:'green,blue'|default:'red'"
OUT.push(";\n        \">\n        "); // ";\n        \">"
OUT.push(G.escapeHTML(G.filters["lower"](CTX.state.username))); // "state.username|lower"
OUT.push("\n    </h5>\n</div>\n\n"); // "</h5>\n</div>"
...
return { "initializedCallback": typeof initializedCallback !== "undefined" ? initializedCallback : undefined,
 setLocalVariable: __set, exports: script.exports}
};Modulo.assets.functions["x1qjagc4"]= function (CTX, G){
var OUT=[];
OUT.push("\n<p>User \"<em>"); // "<p>User \"<em>"
OUT.push(G.escapeHTML(CTX.state.username)); // "state.username"
OUT.push("</em>\" sent a message:</p>\n<div class=\"msgcontent\">\n    "); // "</em>\" sent a message:</p>\n<div class=\"msgcontent\">"
OUT.push(G.escapeHTML(G.filters["safe"](CTX.state.content))); // "state.content|safe"
OUT.push("\n</div>\n"); // "</div>"

return OUT.join("");
};Modulo.assets.functions["x1rqc3nb"]= function (CTX, G){
var OUT=[];
OUT.push("\n  <div class=\"grid\">\n    "); // "<div class=\"grid\">"
...
OUT.push("\n          <div\n            @click:=script.toggle\n            payload:='[ "); // "<div\n            @click:=script.toggle\n            payload:='["
OUT.push(G.escapeHTML(CTX.i)); // "i"
OUT.push(", "); // ","
OUT.push(G.escapeHTML(CTX.j)); // "j"
OUT.push(" ]'\n            "); // "]'"
...
return OUT.join("");
};Modulo.assets.functions["x1sp2v9t"]= function (CTX, G){
var OUT=[];
...
OUT.push(G.escapeHTML(CTX.script.exports.loadingGif)); // "script.exports.loadingGif"
...
OUT.push(G.escapeHTML(CTX.result.cover_i)); // "result.cover_i"
OUT.push("-S.jpg\" />\n                    <label>"); // "-S.jpg\" />\n                    <label>"
OUT.push(G.escapeHTML(CTX.result.title)); // "result.title"
OUT.push("</label>\n                </div>\n            "); // "</label>\n                </div>"
...
return OUT.join("");
};Modulo.assets.functions["x1ttadi3"]= function (CTX, G){
var OUT=[];
OUT.push("\n<ul>\n    "); // "<ul>"
...
"initializedCallback": typeof initializedCallback !== "undefined" ? initializedCallback : undefined,
 setLocalVariable: __set, exports: script.exports}
};Modulo.assets.functions["xgr3fcp"]= function (CTX, G){
var OUT=[];
...
OUT.push("\n            "); // ""
OUT.push(G.escapeHTML(G.filters["brokenFilter"](CTX.state.num))); // "state.num|brokenFilter"
OUT.push("\n        "); // ""
} // "endif"
OUT.push("\n    "); // ""

return OUT.join("");
};Modulo.assets.functions["xh3ap9f"]= function (CTX, G){
var OUT=[];
OUT.push("\n  <div class=\"grid\">\n    "); // "<div class=\"grid\">"
var ARR0=CTX.script.exports.range;for (var KEY in ARR0) {CTX. i=ARR0[KEY]; // "for i in script.exports.range"
...
return OUT.join("");
};Modulo.assets.functions["xmtcsc3"]= function (CTX, G){
var OUT=[];
OUT.push("\n    <h1>hello "); // "<h1>hello"
OUT.push("</h1>\n    "); // "</h1>"
/* // "comment"
...
if (CTX.a) { // "if a"
OUT.push("<div>"); // "<div>"
OUT.push(G.escapeHTML(CTX.b)); // "b"
OUT.push("</div>"); // "</div>"
} // "endif"
OUT.push("\n      <h3>"); // "<h3>"
OUT.push(G.escapeHTML(G.filters["first"](CTX.state.items))); // "state.items|first"
OUT.push("</h3>\n    "); // "</h3>"
*/ // "endcomment"
OUT.push("\n    <p>Below the greeting...</p>\n"); // "<p>Below the greeting...</p>"

return OUT.join("");
};Modulo.assets.functions["xnjq9ng"]= function (CTX, G){
var OUT=[];
...
return OUT.join("");
};Modulo.assets.functions["xqm4217"]= function (CTX, G){
var OUT=[];
OUT.push("\n"); // ""
...
OUT.push("\n        "); // ""
OUT.push("\n        <div key=\"c"); // "<div key=\"c"
OUT.push(G.escapeHTML(CTX.card.id)); // "card.id"
OUT.push("\"\n            class=\"card\n            "); // "\"\n            class=\"card"
...
if ((CTX.state.revealed).includes ? (CTX.state.revealed).includes(CTX.card.id) : (CTX.card.id in CTX.state.revealed)) { // "if card.id in state.revealed"
OUT.push("\n                "); // ""
OUT.push(G.escapeHTML(CTX.card.symbol)); // "card.symbol"
OUT.push("\n            "); // ""
} // "endif"
OUT.push("\n        </div>\n    "); // "</div>"
} // "endfor"
...
OUT.push("\">\n        "); // "\">"
OUT.push(G.escapeHTML(CTX.state.message)); // "state.message"
OUT.push("</p>\n"); // "</p>"
} // "endif"
OUT.push("\n"); // ""

return OUT.join("");
};Modulo.assets.functions["xsi701f"]= function (CTX, G){
var OUT=[];
OUT.push("\n<p>There are <em>"); // "<p>There are <em>"
OUT.push(G.escapeHTML(CTX.state.count)); // "state.count"
OUT.push("\n  "); // ""
OUT.push(G.escapeHTML(G.filters["pluralize"](CTX.state.count,"articles,article"))); // "state.count|pluralize:\"articles,article\""
OUT.push("</em>\n  on "); // "</em>\n  on"
OUT.push(G.escapeHTML(CTX.script.exports.title)); // "script.exports.title"
OUT.push(".</p>\n\n"); // ".</p>"
OUT.push("\n"); // ""
...
OUT.push(G.escapeHTML(G.filters["upper"](CTX.article.headline))); // "article.headline|upper"
OUT.push("</h4>\n    "); // "</h4>"
if (CTX.article.tease) { // "if article.tease"
OUT.push("\n      <p>"); // "<p>"
OUT.push(G.escapeHTML(G.filters["truncate"](CTX.article.tease,30))); // "article.tease|truncate:30"
OUT.push("</p>\n    "); // "</p>"
} // "endif"
OUT.push("\n"); // ""
} // "endfor"
...
return OUT.join("");
};Modulo.assets.functions["xvdjht9"]= function (CTX, G){
var OUT=[];
...
Modulo.globalLoader.loadString("<load namespace=\"x\" src=\"/components/layouts.html\"></load><!--<load src=\"/components/embeddedexampleslib.html\" namespace=\"docseg\"></load>--><!-- <Component name=\"HelloWorldFinal\"><Props goal ></Props><Template> Hello <strong>Modulo</strong> World! <p>Goal: {{ props.goal }}</p><p>Amount: {{ state.amount }}</p><button @click:=script.countUp> Click to count to the goal! </button> {% if props.goal gt state.amount %} <p>Amount is lower than goal</p> {% else %} <p>Amount is higher than goal</p> {% endif %} </Template><State amount:=0 ></State><Script> function countUp() { console.log('button got clicked!'); state.amount++; } </Script><Style> :host { background: gray; width: 100px; height: 100px; border: 1px dotted black; } </Style></Component> -->");
