 ...
 "x": [
  {
   ...
   "cachedComponentDefs": {
    "/libraries/eg.html": {
     ...
     "DataVis": "<Template>\n    <p>User data:</p>\n    <table class=\"charts-css area\" id=\"my-chart\">\n      <tbody>\n        {% for user in staticdata %}\n            <tr><td style=\"--start: 0.{{ user.id }}; --size: {{ user.address.geo.lat }}\">\n                <span class=\"data\"> {{ user.id }}</span></td></tr>\n        {% endfor %}\n      </tbody>\n    </table>\ng/Template>\n\n<StaticData\n    -src=\"https://jsonplaceholder.typicode.com/users\"\n></StaticData>\n<Style\n  -src=\"https://unpkg.com/charts.css/dist/charts.min.css\"\n></Style>\n",
...
currentModulo.assets.functions["xcd8ttb"]= function (tagName, modulo){
...
currentModulo.assets.functions["x1tn6s1b"]= function (tagName, modulo){

    const { StaticData, Template } = modulo.registry.cparts;
    const confArray = modulo.defs['x_x_mws_ProjectInfo'];
    const initRenderObj = {};
    initRenderObj.staticdata = StaticData.factoryCallback(initRenderObj, confArray[0], modulo);
    class ProjectInfo extends modulo.registry.utils.BaseElement {
        constructor() {
            super();
            this.modulo = modulo;
            this.defHash = 'sbo1sp';
    ...
    modulo.globals.customElements.define(tagName, ProjectInfo);
    //console.log("Registered: ProjectInfo as " + tagName);
    return ProjectInfo;
...
currentModulo.assets.functions["x16e1l10"]= function (CTX, G){
var OUT=[];
...
currentModulo.assets.functions["x17mj9l1"]= function (){
return {
  "name": "mdu-cli",
  "author": "michaelb",
  "version": "0.0.1",
...
currentModulo.assets.functions["18r3168"]= function (CTX, G){
var OUT=[];
  OUT.push("\n        v: "); // "v:"
...
currentModulo.assets.functions["18unb67"]= function (){
return {
  "id": 320452827,
  ...
  "pushed_at": "2022-09-18T02:10:26Z",
...
currentModulo.assets.functions['xcd8ttb']('mws-page', currentModulo);

currentModulo.assets.functions['x1tn6s1b']('mws-projectinfo', currentModulo);
