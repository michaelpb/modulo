...
return {  setLocalVariable: __set, exports: script.exports}
};Modulo.assets.functions["x6kpnuq"]= function (CTX, G){
var OUT=[];
OUT.push("\n    <table>\n    "); // "<table>"
...
OUT.push("</td>\n            <td>"); // "</td>\n            <td>"
OUT.push(G.escapeText(G.filters["truncate"](CTX.item.title,5))); // "item.title|truncate:5"
OUT.push("</td>\n            <td>"); // "</td>\n            <td>"
OUT.push(G.escapeText(G.filters["truncate"](CTX.item.body,10))); // "item.body|truncate:10"
OUT.push("</td>\n        </tr>\n    "); // "</td>\n        </tr>"
} // "endfor"
OUT.push("\n    </table>\n"); // "</table>"
